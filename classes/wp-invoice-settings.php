...
class WP_Invoice_Settings {
    ...
    function admin_enqueue_scripts( $hook ) {
		...
		/* jQuery Chosen */
		wp_enqueue_script( 'jquery-chosen', plugins_url( 'js/chosen.jquery.min.js', WP_INVOICE_FILE ), array( 'jquery' ), '1.0.0', false );
		wp_enqueue_style( 'jquery-chosen', plugins_url( 'css/chosen.css', WP_INVOICE_FILE ), false, '1.0.0', 'screen' );
		
		/* Admin */
		wp_enqueue_style( $this->domain, plugins_url( 'css/options.css', WP_INVOICE_FILE ), false, '', 'screen' );
		
		/* Genericons */
		wp_enqueue_style( 'genericons', plugins_url( 'css/genericons.css', WP_INVOICE_FILE ), false, '', 'screen' );
    }
